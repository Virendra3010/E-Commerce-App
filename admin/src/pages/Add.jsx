...
const onSubmitHandler = async (e) => {
  ...
  try {
    ...
    formData.append("bestseller",setBestseller)
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e) => setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type="textarea" placeholder='Write content here' required />
      </div>
